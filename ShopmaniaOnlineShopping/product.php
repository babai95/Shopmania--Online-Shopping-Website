        ...
        <ul class="ul1">
                ...
                <li class='li1'> <a align="center" id='menu' href='product.php'>products</a></li>
                 ...
                 <li class='li1'> <a align="center" id='menu' href='showrecord.php'>showrecord</a></li>
                  <li class='li1'> <a align="center" id='menu' href='product2.php'>Add to Cart</a></li>
                  <li class='li2'> <?php if(isset($_SESSION['id'])) echo"<a id='menu' href='buy.php'>buy</a>";?></li>
                  
                   <li class='li1'><a align="center" id='menu' href='electronics.php'>Electronics</a></li>
            
           
                <li class='li1'> <a id='menu' href='clothes.php'>Clothes</a></li>
                <li class='li1'> <a id='menu' href='books.php'>Books</a></li>
